import { PingResponse, PingRequest } from "./_proto/mwitkow/grpcweb/test/test_pb";
import { Empty } from "google-protobuf/google/protobuf/empty_pb";

export class TestService {
  static serviceName: string = "mwitkow.grpcweb.test.TestService";
}
...
export class FailService {
  static serviceName: string = "mwitkow.grpcweb.test.FailService";
}
