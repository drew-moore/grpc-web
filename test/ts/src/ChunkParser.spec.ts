...
describe("ChunkParser", () => {
  describe("decodeASCII", () => {
    function testDecode(testCase: string) {
      ...
      console.log(encodeASCII(testCase).join(","));
    ...
    it("should allow valid HTTP headers around", () => {
      assert.equal(decodeASCII(new Uint8Array([
          85,115,101,114,45,65,103,101,110,116,58,32,77,111,122,105,108,108,97,47,53,46,48,32,40,87,105,110,100,111,119,
          115,32,78,84,32,49,48,46,48,59,32,87,105,110,54,52,59,32,120,54,52,59,32,114,118,58,53,55,46,48,41,32,71,101,
          99,107,111,47,50,48,49,48,48,49,48,49,32,70,105,114,101,102,111,120,47,53,55,46,48,13,10
        ])),
    ...
    it("should allow quoted headers", () => {
      assert.equal(decodeASCII(new Uint8Array([
          97,108,116,45,115,118,99,58,32,104,113,61,34,58,52,52,51,34,59,32,109,97,61,50,53,57,50,48,48,48,59,32,113,
          117,105,99,61,53,49,51,48,51,52,51,49,59,32,113,117,105,99,61,53,49,51,48,51,51,51,57,59,32,113,117,105,99,
          61,53,49,51,48,51,51,51,56,59,32,113,117,105,99,61,53,49,51,48,51,51,51,55,59,32,113,117,105,99,61,53,49,51,
          48,51,51,51,53,44,113,117,105,99,61,34,58,52,52,51,34,59,32,109,97,61,50,53,57,50,48,48,48,59,32,118,61,34,
          52,49,44,51,57,44,51,56,44,51,55,44,51,53,34,13,10
        ])),
