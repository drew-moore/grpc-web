...
type PingRequest struct {
	...
	FailureType       PingRequest_FailureType `protobuf:"varint,5,opt,name=failure_type,json=failureType,enum=mwitkow.grpcweb.test.PingRequest_FailureType" json:"failure_type,omitempty"`
}
...
func init() {
	...
	proto.RegisterEnum("mwitkow.grpcweb.test.PingRequest_FailureType", PingRequest_FailureType_name, PingRequest_FailureType_value)
}
...
func (c *failServiceClient) NonExistant(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PingResponse, error) {
	out := new(PingResponse)
	err := grpc.Invoke(ctx, "/mwitkow.grpcweb.test.FailService/NonExistant", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _FailService_NonExistant_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mwitkow.grpcweb.test.FailService/NonExistant",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _FailService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "mwitkow.grpcweb.test.FailService",
...
var fileDescriptor0 = []byte{
	...
	,
}
